-- 1️ Validating that total revenue is consistent across layers
SELECT
...
-- 2️ Confirming the number of unique orders matches
SELECT
...
-- 3️ Checking for duplicate primary keys in dim_customers
